...
public:
    ...
    class placed_units_mapmaker_properties_flags_t;
    class string_data_t;
    ...
    class placed_units_state_flags_t;
...
public:
    ...
    public:
        ...
        upgrade_restrictions_t(kaitai::kstream* p__io, chk_t::data_type_t* p__parent = 0, chk_t* p__root = 0);
    ...
    class placed_units_mapmaker_properties_flags_t : public kaitai::kstruct {

    public:

        placed_units_mapmaker_properties_flags_t(kaitai::kstream* p__io, chk_t::placed_units_t* p__parent = 0, chk_t* p__root = 0);
    ...
    public:
        ~placed_units_mapmaker_properties_flags_t();
    ...
    private:
        ...
        uint64_t m_unused;
        chk_t* m__root;
        chk_t::placed_units_t* m__parent;
    ...
    public:
        ...
        chk_t* _root() const { return m__root; }
        chk_t::placed_units_t* _parent() const { return m__parent; }
    };
    ...
    class placed_units_special_properties_flags_t : public kaitai::kstruct {

    public:

        placed_units_special_properties_flags_t(kaitai::kstream* p__io, chk_t::placed_units_t* p__parent = 0, chk_t* p__root = 0);
    ...
    public:
        ~placed_units_special_properties_flags_t();

    private:
        bool m_cloak_valid;
        bool m_burrow_valid;
        bool m_transit_valid;
        bool m_hallucinated_valid;
        bool m_invincible_valid;
        uint64_t m_unused;
        chk_t* m__root;
        chk_t::placed_units_t* m__parent;

    public:
        bool cloak_valid() const { return m_cloak_valid; }
        bool burrow_valid() const { return m_burrow_valid; }
        bool transit_valid() const { return m_transit_valid; }
        bool hallucinated_valid() const { return m_hallucinated_valid; }
        bool invincible_valid() const { return m_invincible_valid; }
        uint64_t unused() const { return m_unused; }
        chk_t* _root() const { return m__root; }
        chk_t::placed_units_t* _parent() const { return m__parent; }
    };
    ...
    private:
        cuwp_slots_special_properties_flags_t* m_special_properties;
        cuwp_slots_validity_flags_t* m_validity;
        ...
        cuwp_slots_unit_flags_t* m_unit_flags;
        uint32_t m_unused;
        chk_t* m__root;
        chk_t::cuwp_slots_array_t* m__parent;

    public:
        cuwp_slots_special_properties_flags_t* special_properties() const { return m_special_properties; }
        cuwp_slots_validity_flags_t* validity() const { return m_validity; }
        ...
        cuwp_slots_unit_flags_t* unit_flags() const { return m_unit_flags; }
    ...
    public:
        ...
        cuwp_slots_validity_flags_t(kaitai::kstream* p__io, chk_t::cuwp_slots_t* p__parent = 0, chk_t* p__root = 0);
    ...
    public:
        ...
        chk_t* _root() const { return m__root; }
        chk_t::cuwp_slots_t* _parent() const { return m__parent; }
    };
    ...
    private:
        ...
        placed_units_special_properties_flags_t* m_special_properties;
        placed_units_mapmaker_properties_flags_t* m_mapmaker_properties;
        ...
        uint32_t m_resource_amount;
        uint16_t m_units_in_hangar;
        placed_units_state_flags_t* m_unit_state;
        uint32_t m_unused;
    ...
    public:
        ...
        placed_units_special_properties_flags_t* special_properties() const { return m_special_properties; }
        placed_units_mapmaker_properties_flags_t* mapmaker_properties() const { return m_mapmaker_properties; }
        ...
        uint32_t resource_amount() const { return m_resource_amount; }
        uint16_t units_in_hangar() const { return m_units_in_hangar; }
        placed_units_state_flags_t* unit_state() const { return m_unit_state; }
        uint32_t unused() const { return m_unused; }
    ...
    class placed_units_state_flags_t : public kaitai::kstruct {

    public:

        placed_units_state_flags_t(kaitai::kstream* p__io, chk_t::placed_units_t* p__parent = 0, chk_t* p__root = 0);
    ...
    class cuwp_slots_special_properties_flags_t : public kaitai::kstruct {

    public:

        cuwp_slots_special_properties_flags_t(kaitai::kstream* p__io, chk_t::cuwp_slots_t* p__parent = 0, chk_t* p__root = 0);
    ...
    public:
        ~cuwp_slots_special_properties_flags_t();

    private:
        bool m_cloak_valid;
        bool m_burrowed_valid;
        bool m_transit_valid;
        bool m_hallucinated_valid;
        bool m_invincible_valid;
        uint64_t m_unused;
    ...
    public:
        bool cloak_valid() const { return m_cloak_valid; }
        bool burrowed_valid() const { return m_burrowed_valid; }
        bool transit_valid() const { return m_transit_valid; }
        bool hallucinated_valid() const { return m_hallucinated_valid; }
        bool invincible_valid() const { return m_invincible_valid; }
        uint64_t unused() const { return m_unused; }
    ...
    class cuwp_slots_unit_flags_t : public kaitai::kstruct {

    public:

        cuwp_slots_unit_flags_t(kaitai::kstream* p__io, chk_t::cuwp_slots_t* p__parent = 0, chk_t* p__root = 0);
    ...
    public:
        bool cloaked() const { return m_cloaked; }
        bool burrowed() const { return m_burrowed; }
        bool transit() const { return m_transit; }
        bool hallucinated() const { return m_hallucinated; }
        bool invincible() const { return m_invincible; }
    ...
    public:
        ...
        tech_restrictions_t(kaitai::kstream* p__io, chk_t::data_type_t* p__parent = 0, chk_t* p__root = 0);
